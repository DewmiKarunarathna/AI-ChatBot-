# AI-ChatBot-
I am going to learn about advanced python parts by making a simple chatBot

# Features:
-patterns attribute to identify patterns in the conversation with the user
-functions like handle greeting, handle_help is included
